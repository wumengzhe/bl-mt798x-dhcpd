...
const static struct {
	...
	{"mt7981-rfb-emmc", "Image on eMMC", 0},
	{"mt7981-rfb-sd", "Image on SD", 0},
	{"mt7981-rfb-snfi-nand", "Image on SNFI-NAND", 0},
	{"mt7981-rfb-spim-nand", "Image on SPIM-NAND (UBI)", 0},
	{"mt7981-rfb-spim-nand-factory", "UBI \"factory\" volume config", -1},
	{"mt7981-rfb-spim-nand-nmbm", "Image on SPIM-NAND (NMBM)", 0},
	{"mt7981-rfb-spim-nor", "Image on SPI-NOR", 0},
};
